...
function addTask(){
    ...
    input.value = '';
    task.style.cssText = 'width: 30vw; height: 30px; background-color: #08a59d; color: #eaeaea; text-align: center; margin-top: -4.3vh; border-radius: 10px; font-weight: 500; font-size: 18px; padding-top: 4px;'
